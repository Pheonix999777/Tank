...
import photo1 from "../../assets/img/image car1.png";
import photo2 from "../../assets/img/image car2.png";
import photo3 from "../../assets/img/image car3.png";
import photo4 from "../../assets/img/image car4.png";
import photo5 from "../../assets/img/image car5.png";
...
export const Service = () => {
  ...
  const images = [Img1, Img2, Img, Img3, Img4];
  const colors = ["#ef2929", "#ff9549", "#c6c9ce", "#212329", "#e6e7e8"];
      ...
      <Container>
        <div className="service__main">
          <div className="service__box">
            ...
            <h2 className="service__title">TANK 300 </h2>
            <h3 className="service__info">
